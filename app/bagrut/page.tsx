...
export const metadata: Metadata = {
  ...
  description:
    'שיעורים פרטיים במתמטיקה לבגרות - 3, 4, 5 יחידות. מורה פרטי עם 100 בבגרות ותואר בהצטיינות. שיטה מוכחת, ליווי אישי, ולמידה בלי חרדות. צרו קשר עוד היום!',
  keywords: [
    'הכנה לבגרות מתמטיקה',
...
const FAQ = [
  ...
  { question: 'איך עובדים השיעורים?', answer: 'שיעורים ב-Teams עם שיתוף מסך. בסוף כל שיעור מקבלים PDF של כל מה שנלמד + גישה להקלטה.' },
  { question: 'כמה שיעורים צריך עד לבגרות?', answer: 'תלוי בפערים ובמועד הבחינה. נקבע ביחד תוכנית ריאלית אחרי שיעור ההיכרות. תלמידים עם 4-6 שבועות לפנינו משיגים תוצאות משמעותיות.' },
]
