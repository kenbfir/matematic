...
export const metadata: Metadata = {
  ...
  description:
    'שיעורים פרטיים במתמטיקה אונליין עם בן כפיר. הכנה לבגרות, חטיבת ביניים, קורסים אקדמיים ותוכנית מצטיינים. צרו קשר עוד היום!',
  keywords: [
    'מורה פרטי למתמטיקה',
  ...
  openGraph: {
    title: 'Matematic | מורה פרטי למתמטיקה אונליין - בן כפיר',
    description:
      'שיעורים פרטיים במתמטיקה אונליין. הכנה לבגרות, חטיבת ביניים, קורסים אקדמיים. צרו קשר עוד היום!',
    locale: 'he_IL',
    type: 'website',
  },
}
