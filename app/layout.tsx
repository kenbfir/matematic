...
export const metadata: Metadata = {
  ...
  description:
    'שיעורים פרטיים במתמטיקה אונליין עם בן כפיר. הכנה לבגרות, חטיבת ביניים, קורסים אקדמיים ותוכנית מצטיינים. שיעור ניסיון חינם!',
  keywords: [
    'מורה פרטי למתמטיקה',
  ...
  openGraph: {
    title: 'LevelUp | מורה פרטי למתמטיקה אונליין — בן כפיר',
    description:
      'שיעורים פרטיים במתמטיקה אונליין. הכנה לבגרות, חטיבת ביניים, קורסים אקדמיים. שיעור ניסיון חינם!',
    locale: 'he_IL',
    type: 'website',
  },
}
